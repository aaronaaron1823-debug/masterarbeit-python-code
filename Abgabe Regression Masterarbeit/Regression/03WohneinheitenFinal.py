...
SHOW_FIG = False  
FIG_DIR  = "figures"
FIG_NAME = "wohneinheiten_nb2_bootstrap.pdf"
...
# 
cols_used = [XCOL, YCOL, GCOL, ACOL, HCOL]
...
print("\n--- NB2 (Bootstrap) — Formel (Offset log(Bev.), Regressoren: lnGpc, lnA(Fläche), Haushaltsgröße) ---")
